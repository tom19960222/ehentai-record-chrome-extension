...
exports.MetadataServerRequest = MetadataServerRequest;
var ViewerTypeEnum;
(function (ViewerTypeEnum) {
    ViewerTypeEnum["BookList"] = "book_list";
    ViewerTypeEnum["BookDetail"] = "book_detail";
    ViewerTypeEnum["BookSingleImagePage"] = "book_single_image_page";
    ViewerTypeEnum["MultiPageViewer"] = "multi_page_viewer";
})(ViewerTypeEnum = exports.ViewerTypeEnum || (exports.ViewerTypeEnum = {}));
class ReadEvent {
    constructor({ viewer_type, gid, page_number }) {
...
exports.EventServerRequest = EventServerRequest;
class ServerRequestAction {
    constructor() {
        this.queryMetadataFromEHentaiAPIServer = (apiService, galleryId, galleryToken) => __awaiter(this, void 0, void 0, function* () {
            const data = {
                'method': 'gdata',
                'gidlist': [
        ...
        this.sendMetadataToServer = (metadata) => __awaiter(this, void 0, void 0, function* () {
            ...
            const headers = { 'Content-Type': 'application/json' };
            const response = yield axios_1.default.post(SERVER_URL, data, { headers });
            return new MetadataServerRequest(response.data);
        });
        this.sendEventToServer = (event) => __awaiter(this, void 0, void 0, function* () {
...
class Main {
    constructor(document) {
        ...
        this.serverRequestAction = new ServerRequestAction_1.ServerRequestAction();
    }
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (urlInfo.position) {
                case model_1.Position.gallery:
                    ...
                    const metadata = yield this.serverRequestAction.queryMetadataFromEHentaiAPIServer(urlInfo.site, urlInfo.galleryId, urlInfo.galleryToken);
                    yield this.serverRequestAction.sendMetadataToServer(metadata);
                    yield this.serverRequestAction.sendEventToServer(new ServerRequestAction_1.ReadEvent({
                        viewer_type: ServerRequestAction_1.ViewerTypeEnum.BookDetail,
                        gid: urlInfo.galleryId,
                        page_number: urlInfo.page
                    }));
                    break;
                case model_1.Position.single:
                    yield this.serverRequestAction.sendEventToServer(new ServerRequestAction_1.ReadEvent({
                        viewer_type: ServerRequestAction_1.ViewerTypeEnum.BookSingleImagePage,
                        gid: urlInfo.galleryId,
                        page_number: urlInfo.page
                    }));
                    new singlePageReadTracker_1.singlePageReadTracker({ serverRequestAction: this.serverRequestAction, galleryInfo: urlInfo });
                    break;
...
exports.GalleryInfo = GalleryInfo;

},{}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const ServerRequestAction_1 = require("./ServerRequestAction");
class mpvPageReadTracker {
    constructor({ serverRequestAction, galleryInfo }) {
                ...
                if (mutation.type === "attributes") {
                    ...
                    if (matchResult.length > 1) {
                        if (!(readPages.has(matchResult[1]))) {
                            ...
                            self.serverRequestAction.sendEventToServer(new ServerRequestAction_1.ReadEvent({
                                viewer_type: ServerRequestAction_1.ViewerTypeEnum.MultiPageViewer,
...
exports.mpvPageReadTracker = mpvPageReadTracker;
exports.default = mpvPageReadTracker;
    ...
    constructor({ serverRequestAction, galleryInfo }) {
        ...
        const observer = new MutationObserver(function (mutations) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const URLNowInfo = util_1.extractURLInformation(URLNow);
                yield self.serverRequestAction.sendEventToServer(new ServerRequestAction_1.ReadEvent({
                    viewer_type: ServerRequestAction_1.ViewerTypeEnum.BookSingleImagePage,
...
function extractURLInformation(URL) {
    ...
    if (singlePageMatch && singlePageMatch.length === 5)
        return new model_1.GalleryInfo({
            position: model_1.Position.single,
